    ...
    extends ComponentBase
{
    ...
    @Override public Widget doInit()
    {
        ...
        Widget htmlH1 = new HTML("<h1>Fortress Defects</h1>");

        vPanel.add(htmlH1);

        // Label label = new Label("Fortress defects associated with the
        // ElectricCommander job:");
        Widget htmlLabel = new HTML(
                "<p><b>Fortress defects associated with the ElectricCommander job:</b></p>");
        ...
        vPanel.add(new HTML(
                "<p><b>Fortress updated defects associated with the ElectricCommander job:</b></p>"));
        ...
        vPanel.add(new HTML(
                "<p><b>Fortress created defects associated with the ElectricCommander job:</b></p>"));
            ...
            final FormTable      formTable)
    {
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug(
                "Fortress Reports doInit: setting up getProperties command request");
        }
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug(
                "Fortress Reports doInit: Issuing Commander request: "
        ...
        fileDefectButton.addClickHandler(new ClickHandler() {
                ...
                public void onClick(ClickEvent event)
                {
                    ...
                    request.setProjectName(
                            "/plugins/EC-DefectTracking-Fortress/project")
                        ...
                        .setCallback(new RunProcedureResponseCallback() {
                                @Override public void handleResponse(
                                        com.electriccloud.commander.client
                                        .responses.RunProcedureResponse                               response)
                                {
